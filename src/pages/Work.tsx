      ...
      <main className="min-h-screen bg-bg pt-28 pb-16 md:pt-32">
        <div className="mx-auto max-w-[1060px] px-6 md:px-10">
            ...
            {PROJECTS.map((project, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row">
                  <div className="w-full bg-bg p-6 md:w-[46%] md:p-8">
                    <div className="overflow-hidden rounded-lg border border-white/10 bg-[#0a0a0a]/80 shadow-2xl shadow-black/50 ring-1 ring-white/5">
          ...
          <motion.div {...fadeIn} className="mt-10 flex flex-wrap gap-3 border-t border-stroke pt-8">
            <GhostLink to="/" className="px-5 py-2 text-xs sm:text-sm">
              ← Home
            </GhostLink>
            <GhostLink to="/resume" className="px-5 py-2 text-xs sm:text-sm">
              Resume →
            </GhostLink>
          </motion.div>
        </div>
